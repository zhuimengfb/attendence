	...
	<div class="container container-normal">
		<div class="es-section login-section">
			...
			<div class="register-main">
				<form action="${ctx}/console/user/register" method="post"
					...
					<div>
						<div class="form-group">
							<label for="inputAccount">学号/工号</label> <input type="text"
								...
								placeholder="学号" check-type="required number">
						</div>
						<div class="form-group">
						...
						<div id="confirmPasswordDiv" class="form-group">
							<label for="passwordAgain">确认密码</label> <input type="password"
								...
								name="name_passwordAgain" onchange="javascript:confirmPassword()" placeholder="确认密码" >
						</div>
						<div class="form-group">

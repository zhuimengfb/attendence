	...
	<div class="container container-normal">
		<div class="es-section login-section">
			...
			<div class="login-main">
				<form action="${ctx}/console/user/login" method="post" name="login-form" id="login-form"
					enctype="multipart/form-data">
					<div>
						<div class="form-group">
							<label for="inputAccount">学号/工号</label> <input type="text"
								class="form-control" id="inputAccount" name="userAccount"
								placeholder="学号" check-type="required number" required-message="输入不能为空">
						</div>
						<div class="form-group">
						...
						<button type="submit" id="submit" class="btn btn-primary btn-lg btn-block"
							style="background: #2CCCBF" onclick="submit1();">登录</button>
						<div>
							<span style="float:right;margin-top: 15px;">还没有账号？<a
								href="${ctx}/console/user/register">立即注册</a></span>
						</div>
						<!-- <div>

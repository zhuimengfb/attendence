...
<body>
	...
	<div class="container container-normal">
		<div class="es-section login-section">
			...
			<div>
				<form action="${ctx}/console/activity/${activityInfo.id}/edit" method="post"
				id="edit-activity-form" enctype="multipart/form-data">
					<div>
						<div class="form-group">
							<label for="inputTitle">活动标题</label> <input type="text"
								class="form-control" id="inputTitle" name="title"
								value="${activityInfo.title}" placeholder="活动标题" check-type="required" 
								>
						</div>
						<div class="form-group">
							<label for="inputPlace">活动地点</label> <input type="text"
								class="form-control" id="inputPlace" name="place"
								value="${activityInfo.place}" placeholder="活动地点" check-type="required">
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div class="form-group col-lg-6">
								<input type="text" class="form-control" id="inputLatitude"
									name="latitude" placeholder="纬度" value="${activityInfo.latitude}" check-type="required" />
							</div>
							<div class="form-group col-lg-6">
								<input type="text" class="form-control col-lg-6"
									id="inputLongitude" name="longitude" value="${activityInfo.longitude}" placeholder="经度"
									check-type="required" />
							</div>
						</div>
						<div class="row">
							<div class="form-group col-lg-6">
								...
								<div class='input-group date' id='datetimepicker11'>
									<span class="input-group-addon"> <span
										...
										id="startDate" value="${activityStartDate}"/>
								</div>
							</div>
							<div class="form-group col-lg-6">
								...
								<div class='input-group date' id='datetimepicker12'>
									<span class="input-group-addon"> <span
										...
										id="endDate" value="${activityEndDate}"/>
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<textarea class="form-control" rows="5" cols="100"
								id="activityDes" name="activityDes" check-type="required">${activityInfo.activityDes}</textarea>
						</div>
						<div class="form-group">
							<label>活动图片</label>
						...
						<button type="submit" id="submit"
							...
							style="background: #2CCCBF" onclick="submit1();">修改活动</button>
					</div>
				</form>
			</div>
		</div>

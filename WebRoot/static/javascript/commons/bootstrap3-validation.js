...
!function($) {
    ...
    $.fn.valid=function(object,options){
        ...
        if(myoptions !=null && validationError){
            ...
            myobject.after('<span id="validerrmsg" class="help-block" style="color: #fc5d7a;">'+myoptions+'</span>');
        };
        //end
        ...
        if (globalOptions.reqmark==true){
            if(fform_style==0){
                $(obj).find(".form-group>label").each(function(){
                    ...
                    el.after('<span id="autoreqmark" style="color:#fc5d7a"> *</span>')
                });
            }
                ...
                $(obj).find('input, textarea').each(function(){
                    ...
                    if (valid){
                        if ($.inArray('required',valid)>=0){
                           // el.parent().after('<span class="help-block" id="valierr" style="color:#fc5d7a; margin-left:20px;"></span>');
                        }
                    };
                }); 
            };
